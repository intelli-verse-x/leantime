...
class Menu
{
    ...
    public array $menuStructures = [
        ...
        'company' => [
            ...
            40 => ['type' => 'item', 'module' => 'clients',         'role' => 'admin',    'title' => 'menu.all_clients',        'icon' => 'fa fa-fw fa-address-book',   'tooltip' => 'menu.all_clients_tooltip',        'href' => '/clients/showAll',                     'active' => ['showAll']],
    ...
    public function getSectionMenuType($currentRoute, $default = 'default')
    {
        ...
        $sections = [
            ...
            'oneonone.showMy' => 'personal',
            'oneonone.showTeam' => 'company',
            'oneonone.showSession' => 'personal',
