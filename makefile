...
acceptance-test: build-dev
	...
	docker compose --file .dev/docker-compose.yaml --file .dev/docker-compose.tests.yaml exec -u root leantime-dev chmod -R 777 /var/www/html/storage /var/www/html/bootstrap/cache || true
